...
//	SensorUnused2                  = 16,
	...
	void DigitLEDsRaw(uint8_t d3, uint8_t d2, uint8_t d1, uint8_t d0);

	void DigitLEDsASCII(uint8_t d3, uint8_t d2, uint8_t d1, uint8_t d0);
...
private:
	...
	/// Convert int to 7 segment.
	uint8_t SevenSegment(uint8_t number);
};
